...
public class Inventory extends javax.swing.JFrame {
    ...
    public Inventory() {
        initComponents();   
     // Defer the low-stock check until after the GUI is displayed
    SwingUtilities.invokeLater(() -> checkLowStocks());
        
 loadData(); // your custom method to fetch from SQL
...
deleteBtn.setBorder(BorderFactory.createEmptyBorder(5, 10, 5, 10));
    ...
    String message = "Updated: " + variety;
    
    if (newStock < newThreshold) {
        message += "\n⚠ Warning: Stock is below threshold!";
        JOptionPane.showMessageDialog(table, message, "Low Stock Alert", JOptionPane.WARNING_MESSAGE);
    } else {
        JOptionPane.showMessageDialog(table, message, "Update Successful", JOptionPane.INFORMATION_MESSAGE);
    }
